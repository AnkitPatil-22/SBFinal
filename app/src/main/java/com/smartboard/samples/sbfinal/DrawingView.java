...
import com.smartboard.samples.sbfinal.StrokeManager.ContentChangedListener;
...
public class DrawingView extends View implements ContentChangedListener, View.OnTouchListener {
    ...
    private ArrayList<List> contents = new ArrayList<List>();
    private ArrayList<List> undonecontents = new ArrayList<List>();
...
//        currentStroke = new Path();
    ...
    public List<RecognitionTask.RecognizedInk> redrawContent() {
        clear();
        Ink currentInk = strokeManager.getCurrentInk();
        drawInk(currentInk, drawPaint);
...
//        ArrayList<List> newcontent = new ArrayList<List>();
//        newcontent.add(content);
//        content = newcontent;
        System.out.println("The content in Drawing View " + content);
        ...
        for (RecognitionTask.RecognizedInk ri : content) {
            ...
            System.out.println("The answer is "+ri.text);
//            currentStrokePaint.setColor(FFFFFF);


//            List<RecognitionTask.RecognizedInk> newcontent = new ArrayList<>();
//            newcontent.add((RecognitionTask.RecognizedInk) content);
//            System.out.println("The content in returnFunc " + content);
        }
//        newFunc(content);
...
//    public List newFunc(List content){
////        List<RecognitionTask.RecognizedInk> content = strokeManager.getContent();
//        ArrayList<List> newcontent = new ArrayList<List>();
//        newcontent.add(content);
////        content = newcontent;
//        System.out.println("The content in newFunc is " + newcontent);
//        return newcontent;
//    }
    ...
    private void drawTextIntoBoundingBox(String text, Rect bb, TextPaint textPaint) {
        final float arbitraryFixedSize = 15.f;

...
public class StrokeManager {
    ...
    public interface ContentChangedListener {
        ...
        boolean onTouchEventPaint(MotionEvent event);
    ...
    public List<RecognitionTask.RecognizedInk> getContent() {
        System.out.println("The content last element is " + content.get(content.size() - 1));

//        if (content.size() == 1) {
//            return content;
//        } else if (content.size() > 1) {
//            return Collections.singletonList(content.get(content.size() - 1));
//        } else {
//
//            return content;
//        }
    ...
    public List<RecognitionTask.RecognizedInk> getNewContent() {
        return content;
    }
